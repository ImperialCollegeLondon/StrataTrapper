...
for i = 1:N_hom_subs_z
    for j = 1:N_hom_subs_x
        for k = 1:N_hom_subs_y
            ...
            subvol_struct(i,j,k).kg_phase_connected = zeros(n_pts,3);
            subvol_struct(i,j,k).kw_phase_connected = zeros(n_pts,3);
...
disp('Finished generating the upscaled data structure! Woop!')

if Step_save
    save("./Output/post_A2_3", '-v7.3')
end

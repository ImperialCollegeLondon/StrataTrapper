for qq = 1:N_Qg
   ...
   fid1 = fopen(['por_carfin_include_', s_append_base{qq}, '.txt'],'w');
   
   fid2 = fopen(['permx_carfin_include_', s_append_base{qq}, '.txt'],'w');
   fid3 = fopen(['permy_carfin_include_', s_append_base{qq}, '.txt'],'w');
   fid4 = fopen(['permz_carfin_include_', s_append_base{qq}, '.txt'],'w');
